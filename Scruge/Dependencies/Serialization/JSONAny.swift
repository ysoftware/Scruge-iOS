//
//  JSONAny.swift
//  https://stackoverflow.com/a/46372589/1485367
//
//  Created by Ярослав Ерохин on 01.10.2017.
//

import Foundation

/// Класс для преобразования объекта Codable в Any для отправки данных в базу данных Firebase.
public class JSONAny: Codable {
    ...
    static func decode(from container: inout KeyedDecodingContainer<MyCodingKey>,
                       forKey key: MyCodingKey) throws -> Any {
    ...
    static func decodeDictionary(from
        container: inout KeyedDecodingContainer<MyCodingKey>) throws -> [String: Any] {
        var dict = [String: Any]()
