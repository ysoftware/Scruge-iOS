...
final class CampaignViewController_COPY: UIViewController {
...
extension CampaignViewController_COPY: UITableViewDataSource {
...
extension CampaignViewController_COPY: UITableViewDelegate {
...
extension CampaignViewController_COPY: ViewModelDelegate {
...
extension CampaignViewController_COPY: ArrayViewModelDelegate {
